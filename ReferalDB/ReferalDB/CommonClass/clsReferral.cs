...
namespace ReferalDBApplicant.Classes
{
    public class clsReferral
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    model.lukupCloseId = ((from LookUp lukup in DbEntity.LookUps
                                           where (lukup.LookupName == "Closest Relative")
                                           select new
                                           {
                    ...
                    model.lukupLegalGurdianId = ((from LookUp lukup in DbEntity.LookUps
                                                  where (lukup.LookupName == "Court appointed guardian")
                                                  select new
                                                  {
                                                      lukupCloseId = lukup.LookupId
                ...
                using (TransactionScope trans = new TransactionScope(TransactionScopeOption.Required))
                {
                    ...
                    if ((saveId > 0) && (status == "update"))
                    {
                        ...
                        if (type == "General Information")
                        {
                            ...
                            var closeRelAdress = (from objStudntPersnl in DbEntity.StudentPersonals
                                                  ...
                                                  where (Look.LookupType == "Relationship" & StdAddrRel.ContactSequence == 1 & objStudntPersnl.StudentPersonalId == saveId & ConPrsonal.Relation == "Closest Relative")
                                                  select new
                                                  {
                            ...
                            var legalGuardianAdress = (from objStudntPersnl in DbEntity.StudentPersonals
                                                       ...
                                                       join StudContactRel in DbEntity.StudentContactRelationships on ConPrsonal.ContactPersonalId equals StudContactRel.ContactPersonalId
                                                       join Look in DbEntity.LookUps on StudContactRel.RelationshipId equals Look.LookupId
                                                       where (Look.LookupType == "Relationship" & StdAddrRel.ContactSequence == 1 & objStudntPersnl.StudentPersonalId == saveId & ConPrsonal.Relation == "Court appointed guardian")
                                                       select new
                                                       {
                                                           AdresId = Addr.AddressId
                                                       }).ToList();
                            ...
                            var emergncyAdrs = (from objStudntPersnl in DbEntity.StudentPersonals
                                                ...
                                                join StudContactRel in DbEntity.StudentContactRelationships on ConPrsonal.ContactPersonalId equals StudContactRel.ContactPersonalId
                                                join Look in DbEntity.LookUps on StudContactRel.RelationshipId equals Look.LookupId
                                                where (Look.LookupType == "Relationship" & StdAddrRel.ContactSequence == 1 & objStudntPersnl.StudentPersonalId == saveId & ConPrsonal.Relation == "Emergency Contact")
                                                select new
                                                {
                                                    AdresId = Addr.AddressId
                                                }).ToList();
                            ...
                            AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.RefCountry;
                            ...
                            if (ConPersonal != null)
                            {
                                ...
                                AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objRelationMthr.txtCountry;
                            ...
                            if (ConPersonal != null)
                            {
                                ...
                                AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objRelationFthr.txtCountry;
                            ...
                            if (ConPersonal != null)
                            {
                                ...
                                AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objRelationClose.txtCountry;
                            ...
                            else
                            {
                                ...
                                if ((model.objRelationClose.txtFirstName != null && model.objRelationClose.txtFirstName != "") || (model.objRelationClose.txtLstName != null && model.objRelationClose.txtLstName != ""))
                                {
                                    ...
                                    model.objRelationClose.RelationName = "Closest Relative";
                                    ConPersonal.StudentPersonalId = StudentTbl.StudentPersonalId;
                                    ConPersonal.ContactFlag = "Referral";
                                    ConPersonal.Status = 1;
                                    ConPersonal.FirstName = model.objRelationClose.txtFirstName;
                                    ConPersonal.LastName = model.objRelationClose.txtLstName;
                                    ConPersonal.MiddleName = model.objRelationClose.txtMiddleName;
                                    ConPersonal.Relation = "Closest Relative";
                                    ConPersonal.Spouse="Closest Relative";
                                    ConPersonal.CreatedBy = loginId;
                                    ConPersonal.CreatedOn = DateTime.Now;
                                    DbEntity.ContactPersonals.Add(ConPersonal);
                                    DbEntity.SaveChanges();
                            ...
                            if (ConPersonal != null)
                            {
                                ...
                                StdCntctRel = DbEntity.StudentContactRelationships.Where(objRel => objRel.ContactPersonalId == LegalContactPersnlId).SingleOrDefault();
                                StdCntctRel.RelationshipId = model.objRelationLegalGuardian.LegalGrRelation; 
                                StdCntctRel.ModifiedBy = loginId;
                                StdCntctRel.ModifiedOn = DateTime.Now;
                                DbEntity.SaveChanges();

                                AddrList = DbEntity.AddressLists.Where(objAdr => objAdr.AddressId == legalGuardianAdressId).SingleOrDefault();
                                AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objRelationLegalGuardian.txtCountry;
                            ...
                            else
                            {
                                if ((model.objRelationLegalGuardian.txtFirstName != null && model.objRelationLegalGuardian.txtFirstName != "") || (model.objRelationLegalGuardian.txtLstName != null && model.objRelationLegalGuardian.txtLstName != ""))
                                {
                                    ...
                                    if (model.objRelationLegalGuardian.LegalGrRelation == 0)
                                        model.objRelationLegalGuardian.LegalGrRelation = model.lukupLegalGurdianId;

                                    ConPersonal.StudentPersonalId = StudentTbl.StudentPersonalId;
                                    ConPersonal.FirstName = model.objRelationLegalGuardian.txtFirstName;
                                    ConPersonal.LastName = model.objRelationLegalGuardian.txtLstName;
                                    ConPersonal.MiddleName = model.objRelationLegalGuardian.txtMiddleName;
                                    ConPersonal.Spouse = "Court appointed guardian";
                                    ConPersonal.Relation = "Court appointed guardian";
                                    ConPersonal.ContactFlag = "Referral";
                                    ConPersonal.Status = 1;
                                    ConPersonal.CreatedBy = loginId;
                                    ConPersonal.CreatedOn = DateTime.Now;
                            ...
                            if (ConPersonal != null)
                            {
                                ...
                                StdCntctRel = DbEntity.StudentContactRelationships.Where(objRel => objRel.ContactPersonalId == emergncyContactId).SingleOrDefault();
                                StdCntctRel.RelationshipId = model.objRelationEmergncyContact.EmConRelation;  
                                StdCntctRel.ModifiedBy = loginId;
                                StdCntctRel.ModifiedOn = DateTime.Now;
                                DbEntity.SaveChanges();

                                AddrList = DbEntity.AddressLists.Where(objAdr => objAdr.AddressId == emergncyAdrsId).SingleOrDefault();
                                AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objRelationEmergncyContact.txtCountry;
                            ...
                            else
                            {
                                if ((model.objRelationEmergncyContact.txtFirstName != null && model.objRelationEmergncyContact.txtFirstName != "") || (model.objRelationEmergncyContact.txtLstName != null && model.objRelationEmergncyContact.txtLstName != ""))
                                {
                                    ...
                                    if (model.objRelationEmergncyContact.EmConRelation == 0)
                                        model.objRelationEmergncyContact.EmConRelation = model.lukupEmergencyId;
                                    ...
                                    ConPersonal.LastName = model.objRelationEmergncyContact.txtLstName;
                                    ConPersonal.MiddleName = model.objRelationEmergncyContact.txtMiddleName;
                                    ConPersonal.Spouse = "Emergency Contact";
                                    ConPersonal.Relation ="Emergency Contact";
                                    ConPersonal.CreatedBy = loginId;
                                    ConPersonal.CreatedOn = DateTime.Now;
                                    DbEntity.ContactPersonals.Add(ConPersonal);
                                    DbEntity.SaveChanges();
                        ...
                        else if (type == "Birth And Development History")
                        {
                            try
                            {
                                ...
                                if (AddrList != null)
                                {
                                    ...
                                    AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objPhysicianDetails.txtCountry;
                                ...
                                if (AddrList != null)
                                {
                                    AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objInsuranceDetails.txtCountry;
                                ...
                                if (AddrList != null)
                                {
                                    AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objInsuranceSecDetails.txtCountry;
                                ...
                                if (AddrList != null)
                                {
                                    AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.objInsuranceDentalDetails.txtCountry;
                    ...
                    else
                    {
                        if (type == "General Information")
                        {
                            ...
                            AddrList.CountryId = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single();
                            AddrList.StateProvince = model.RefState;
                            AddrList.City = model.RefCity;
                            AddrList.StreetName = model.RefStreetAdrs;
                            AddrList.ApartmentType = model.RefAptUnit;
                ...
                if (model != null)
                {
                    ...
                    model.objRelationLegalGuardian = (from objStudntPersnl in DbEntity.StudentPersonals
                                                      ...
                                                      select new RelationCLs
                                                      {
                                                          ...
                                                          txtLstName = ConPersonal.LastName,
                                                          txtMiddleName = ConPersonal.MiddleName,
                                                          LgRelationName = ConPersonal.Relation,
                                                          txtCountry = Addr.CountryId,
                                                          txtState = Addr.StateProvince,
                                                          txtStreetAdress = Addr.StreetName,
                                                          txtCity = Addr.City,
                    ...
                    model.objRelationEmergncyContact = (from objStudntPersnl in DbEntity.StudentPersonals
                                                        ...
                                                        select new RelationCLs
                                                        {
                                                            ...
                                                            txtLstName = ConPersonal.LastName,
                                                            txtMiddleName = ConPersonal.MiddleName,
                                                            EmRelationName = ConPersonal.Relation,
                                                            txtCountry = Addr.CountryId,
                                                            txtState = Addr.StateProvince,
                                                            txtStreetAdress = Addr.StreetName,
                                                            txtCity = Addr.City,
        ...
        public GenInfoModel LoadStudentData(int studentId, int Index)
        {
            ...
            if (Index == 1)
            {
                if (model != null)
                {
                    ...
                    {
                        int country = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Country" && objLookup.LookupCode == SetLookUpCode).Select(objlookup => objlookup.LookupId).Single(); //model.RefCountry;
                    ...
                    model.objRelationClose = (from objStudntPersnl in DbEntity.StudentPersonals
                                              ...
                                              join Look in DbEntity.LookUps on StudContactRel.RelationshipId equals Look.LookupId
                                              where (Look.LookupType == "Relationship" & StdAddrRel.ContactSequence == 1 & objStudntPersnl.StudentPersonalId == studentId & ConPersonal.Relation == "Closest Relative")
                                              ...
                                              select new RelationCLs
                                              {
                                                  ...
                                                  txtMiddleName = ConPersonal.MiddleName,
                                                  RelationName = ConPersonal.Relation,
                                                  closeRelation = StudContactRel.RelationshipId,
                                                  txtCountry = Addr.CountryId,
                                                  txtState = Addr.StateProvince,
                                                  txtStreetAdress = Addr.StreetName,
                                                  txtCity = Addr.City,
                    ...
                    model.objRelationLegalGuardian = (from objStudntPersnl in DbEntity.StudentPersonals
                                                      ...
                                                      join StudContactRel in DbEntity.StudentContactRelationships on ConPersonal.ContactPersonalId equals StudContactRel.ContactPersonalId
                                                      join Look in DbEntity.LookUps on StudContactRel.RelationshipId equals Look.LookupId
                                                      where (Look.LookupType == "Relationship" & StdAddrRel.ContactSequence == 1 & objStudntPersnl.StudentPersonalId == studentId & ConPersonal.Relation == "Court appointed guardian")
                                                      select new RelationCLs
                                                      {
                                                          txtFirstName = ConPersonal.FirstName,
                                                          txtLstName = ConPersonal.LastName,
                                                          txtMiddleName = ConPersonal.MiddleName,
                                                          LgRelationName = ConPersonal.Spouse,
                                                          LegalGrRelation = StudContactRel.RelationshipId,
                                                          txtCountry = Addr.CountryId,
                                                          txtState = Addr.StateProvince,
                                                          txtStreetAdress = Addr.StreetName,
                                                          txtCity = Addr.City,
                    ...
                    {
                        //if (model.objRelationLegalGuardian.LgRelationName == null)
                        //    model.objRelationLegalGuardian.LgRelationName = "Court appointed guardian";
                        //model.objRelationLegalGuardian.LegalGrRelation = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Relationship" && objLookup.LookupName == model.objRelationLegalGuardian.LgRelationName).Select(objLookup => objLookup.LookupId).Single();
                        model.objRelationFthr.txtDob = model.objRelationMthr.txtDobdatetime == null ? "" : ((DateTime)model.objRelationMthr.txtDobdatetime).ToString("MM/dd/yyyy".Replace("-", "/"));
                    }
                    else
                    {
                    ...
                    model.objRelationEmergncyContact = (from objStudntPersnl in DbEntity.StudentPersonals
                                                        ...
                                                        join StudContactRel in DbEntity.StudentContactRelationships on ConPersonal.ContactPersonalId equals StudContactRel.ContactPersonalId
                                                        join Look in DbEntity.LookUps on StudContactRel.RelationshipId equals Look.LookupId
                                                        where (Look.LookupType == "Relationship" & StdAddrRel.ContactSequence == 1 & objStudntPersnl.StudentPersonalId == studentId & ConPersonal.Relation == "Emergency Contact")
                                                        select new RelationCLs
                                                        {
                                                            txtFirstName = ConPersonal.FirstName,
                                                            txtLstName = ConPersonal.LastName,
                                                            txtMiddleName = ConPersonal.MiddleName,
                                                            EmRelationName = ConPersonal.Spouse,
                                                            EmConRelation = StudContactRel.RelationshipId,
                                                            txtCountry = Addr.CountryId,
                                                            txtState = Addr.StateProvince,
                                                            txtStreetAdress = Addr.StreetName,
                                                            txtCity = Addr.City,
                    ...
                    {
                        //if (model.objRelationEmergncyContact.EmRelationName == null)
                        //    model.objRelationEmergncyContact.EmRelationName = "Emergency Contact";
                        //model.objRelationEmergncyContact.EmConRelation = DbEntity.LookUps.Where(objLookup => objLookup.LookupType == "Relationship" && objLookup.LookupName == model.objRelationEmergncyContact.EmRelationName).Select(objLookup => objLookup.LookupId).Single();
                        model.objRelationFthr.txtDob = model.objRelationMthr.txtDobdatetime == null ? "" : ((DateTime)model.objRelationMthr.txtDobdatetime).ToString("MM/dd/yyyy".Replace("-", "/"));
                    }
                    else
                    {
                    ...
                    if ((saveId > 0) && (status == "update"))
                    {
                        ...
                        if (type == "General Information")
                        {
                            ...
                            var closeRelAdress = (from objStudntPersnl in DbEntity.StudentPersonals
                                                  ...
                                                  join StudContactRel in DbEntity.StudentContactRelationships on ConPrsonal.ContactPersonalId equals StudContactRel.ContactPersonalId
                                                  join Look in DbEntity.LookUps on StudContactRel.RelationshipId equals Look.LookupId
                                                  where (Look.LookupType == "Relationship" & StdAddrRel.ContactSequence == 1 & objStudntPersnl.StudentPersonalId == saveId & ConPrsonal.Relation == "None")
                                                  select new
                                                  {
                                                      AddressIds = Addr.AddressId
                                                  }).ToList();
                            ...
                            else
                            {
                                ...
                                if ((model.objRelationClose.txtFirstName != null && model.objRelationClose.txtFirstName != "") || (model.objRelationClose.txtLstName != null && model.objRelationClose.txtLstName != ""))
                                {
                                    ...
                                    model.objRelationClose.RelationName = "None";
                                    ConPersonal.StudentPersonalId = StudentTbl.StudentPersonalId;
                                    ConPersonal.ContactFlag = "Referral";
                                    ConPersonal.Status = 1;
                                    ConPersonal.FirstName = model.objRelationClose.txtFirstName;
                                    ConPersonal.LastName = model.objRelationClose.txtLstName;
                                    ConPersonal.MiddleName = model.objRelationClose.txtMiddleName;
                                    ConPersonal.Relation = model.objRelationClose.RelationName;
                                    ConPersonal.CreatedBy = loginId;
                                    ConPersonal.CreatedOn = DateTime.Now;
                                    DbEntity.ContactPersonals.Add(ConPersonal);
                                    DbEntity.SaveChanges();
                            ...
                            if (ConPersonal != null)
                            {
                                ...
                                ConPersonal.MiddleName = model.objRelationEmergncyContact.txtMiddleName;
                                ConPersonal.LastName = model.objRelationEmergncyContact.txtLstName;
                                ConPersonal.Relation = model.objRelationEmergncyContact.RelationName;
                                DbEntity.SaveChanges();
        ...
        public IEnumerable<SelectListItem> getRelationshipList()
        {
            ...
            RelationData = DbEntity.LookUps.Where(x => x.LookupType == "Relationship").OrderBy(x => x.LookupName).ToList();
        ...
        public int countryID()
        {
            ...
            Sp = DbEntity.LookUps.Where(objLookUp => objLookUp.LookupCode == SetLookUpCode).SingleOrDefault();
            return Sp.LookupId;
        }

        public List<SelectListItem> GetFundingList()  //--- 22Sep2020 - List 3 - Task #2 - (Start) ---//
        {
            ...
            var data = (from look in dbobj.LookUps
                        where look.LookupType == "fundingsource"
                        select new SelectListItem
                        {
        ...
        public int? GetFundingSourceID(int Stdid,int Scholid)
        { 
            MelmarkDBEntities objData = new MelmarkDBEntities();
            int? FundID =((from StudentPersonal StdPrs in objData.StudentPersonals
                           where (StdPrs.StudentPersonalId == Stdid && StdPrs.SchoolId == Scholid)
                            select new
                            {
                                lukid = StdPrs.FundingSource
                            }).SingleOrDefault()).lukid;
            return FundID;
        }
